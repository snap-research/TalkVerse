...
def linear_interpolation(features, input_fps, output_fps, output_len=None):
    ...
    """
    # Optimized path for 50fps -> 25fps (2:1 downsampling)
    if input_fps == 50 and output_fps == 25:
        # Simple 2:1 downsampling - take every other frame
        # This is much more efficient than F.interpolate
        return features[:, ::2, :]  # [1, T//2, 512]
    
    # Fallback to original interpolation for other cases

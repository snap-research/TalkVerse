...
class FramePackMotioner(nn.Module):
    ...
    def __init__(
        ...
        self.proj = nn.Conv3d(
            48, inner_dim, kernel_size=(1, 2, 2), stride=(1, 2, 2))
        self.proj_2x = nn.Conv3d(
            48, inner_dim, kernel_size=(2, 4, 4), stride=(2, 4, 4))
        self.proj_4x = nn.Conv3d(
            48, inner_dim, kernel_size=(4, 8, 8), stride=(4, 8, 8))
    ...
    def forward(self, motion_latents, add_last_motion=2):
        ...
        for m in motion_latents:
            ...
            padd_lat = torch.zeros(48, self.zip_frame_buckets.sum(), lat_height,
                                   lat_width).to(
...
if __name__ == '__main__':
    ...
    single_input = torch.ones([48, num_frame, height, width], device=device)
